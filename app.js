...
const CHAPTERS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { t: "l", l: [ "For Gaia is sacred and divine.",
          "Second is genocide",
      ...
      { t: "l", l: [ "And no one need go hungry.",
      ...
      { t: "ci", l: [ "For the path of Phosphorus",
          "Is one of Gnosis.",
  ...
  },
  {
    ...
    sections: [
      ...
      { t: "ci", l: [ "Better than any other",
          ...
          "And then it said," ] },
      { t: "l", l: [ "You have seen the body of Ambivalience",
      ...
      { t: "l", l: [ "This is the form of the hex.",
          ...
          "All at once." ] },
      { t: "ci", l: [ "And the voice said,",
          "This is the form of the guerrilla.",
          ...
          "And the voice said,",
          "This is the form of revelation.",
          "And the form became hardened" ] },
      { t: "l", l: [ "And began to obstruct the paths leading to the tower",
          "And they blocked the roads",
          "And refused entry to the tallest buildings.",
          "And the voice said,",
          "This is the form of obstruction.",
      ...
      { t: "l", l: [ "And watched its actions",
          ...
          "For you have perceived the Trisoma.",
          "Now learn it",
          "Understand it" ] },
      { t: "c", l: [ "And work alongside it",
  ...
  },
  {
    ...
    sections: [
      { t: "ci", l: [ "They had perceived the Trisoma",
      ...
      { t: "l", l: [ "And they returned to where they had begun",
      ...
      { t: "l", l: [ "Shall be called Duosophia.",
          ...
          "And they said,",
          "She is the faint spark of Phosphorus.",
          "And she is given through the breath of her mother.",
          "And she is a shard of Passion.",
          "And she speaks through her lips." ] },
      { t: "l", l: [ "And she walks the channel.",
          "And she resists through the body undone.",
          "And she is in adoration of difference.",
          "And she is a thing of beginnings.",
      ...
      { t: "l", l: [ "In single-minded solidarity",
          "And beneath them",
          "The heath appeared like a clean lake",
          "Reflecting each of them.",
          "And they said,",
          "She is the threaded needle of Phosphorus.",
          "And she is given through the word of her mother.",
          "And she is a shard of Contagion.",
          "And she is sustained through her breast.",
          "And she known through the body ambivalent.",
          "And she is equal with all.",
          "And she is a thing of middles.",
          "And her name is Monosophia",
          "And she is there among you",
          "At times of communion" ] },
      { t: "l", l: [ "In moments of solidarity",
      ...
      { t: "l", l: [ "Yet did not degrade",
          ...
          "And the voice said,",
          "She casts the light of Phosphorus.",
          "And she is given through the whisper of her mother.",
          "And she is a shard of Inspiration.",
          "And she is held within the womb.",
          "And she known through the body of organs.",
          "And she loves all." ] },
      { t: "l", l: [ "And she is a thing of ends.",
          ...
          "At once themself" ] },
      { t: "l", l: [ "And yet part of something massive",
          "At once here",
          "And yet at the end of time.",
          "And another voice whispered to them,",
